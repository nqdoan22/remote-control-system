...
- **Ràng buộc Sandboxing:** Mọi thao tác truy xuất, tải lên, tải xuống chỉ được phép thực hiện trong một thư mục chỉ định sẵn (ví dụ: `C:\AgentSandbox\`). Bất kỳ truy cập nào ra ngoài thư mục này đều bị hệ thống chặn đứng.
