...
Đây là cơ chế bảo mật quan trọng nhất phía End User. Các chức năng: **Screenshot, Live Screen, Webcam, Keylogger, Power Control, File Transfer** bị khóa mặc định.
...
* **Quy tắc Sandbox:** Client App chỉ được phép liệt kê, upload và download các tệp nằm gọn trong một thư mục chỉ định sẵn (Ví dụ: `C:\AgentSandbox\`).
